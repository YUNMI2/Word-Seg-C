...
public:
  void train(const string& trainFile, const string& othertrainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile);
