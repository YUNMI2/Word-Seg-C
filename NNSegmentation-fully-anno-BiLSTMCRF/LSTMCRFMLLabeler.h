...
public:
  ...
  void readTagEmbeddings(const string& inFile,NRMat<dtype>& tagEmb, Alphabet& p_tagAlphabet);
...
public:
  void train(const string& trainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile, const string& wordEmbFile, const string& tagEmbFiles);
